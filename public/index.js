...
var $         = require('./ender')
  ...
  , tmpl = {
        plain: {
          ...
          , code : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/gitter/{pkg}.png"></a></textarea>'
                 + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/gitter/{pkg}.png)](https://nodei.co/gitter/{pkg}/)</textarea>'
        }
      , downloads: {
            img  : '<img src="/gitter/{pkg}.png?downloads=true">'
          , code : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/gitter/{pkg}.png?downloads=true"></a></textarea>'
                 + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/gitter/{pkg}.png?downloads=true)](https://nodei.co/gitter/{pkg}/)</textarea>'
        }
      , 'downloads-stars': {
            img  : '<img src="/gitter/{pkg}.png?downloads=true&stars=true">'
          , code : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/gitter/{pkg}.png?downloads=true&stars=true"></a></textarea>'
                 + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/gitter/{pkg}.png?downloads=true&stars=true)](https://nodei.co/gitter/{pkg}/)</textarea>'
        }
      , compact: {
            img  : '<img src="/gitter/{pkg}.png?compact=true">'
          , code : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/gitter/{pkg}.png?compact=true"></a></textarea>'
                 + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/gitter/{pkg}.png?compact=true)](https://nodei.co/gitter/{pkg}/)</textarea>'
        }
      , mini: {
            img  : '<img src="/gitter/{pkg}.png?mini=true">'
          , code : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/gitter/{pkg}.png?mini=true"></a></textarea>'
                 + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/gitter/{pkg}.png?mini=true)](https://nodei.co/gitter/{pkg}/)</textarea>'
        }
      , dl: {
            img   : '<img src="/npm-dl/{pkg}.png">'
          , imgM  : '<img src="/npm-dl/{pkg}.png?months={months}">'
          , code  : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/npm-dl/{pkg}.png"></a></textarea>'
                  + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/npm-dl/{pkg}.png)](https://nodei.co/gitter/{pkg}/)</textarea>'
          , codeM : '<textarea class="copyable" readonly><a href="https://nodei.co/gitter/{pkg}/"><img src="https://nodei.co/npm-dl/{pkg}.png?months={months}"></a></textarea>'
                  + '<textarea class="copyable" readonly>[![NPM](https://nodei.co/npm-dl/{pkg}.png?months={months})](https://nodei.co/gitter/{pkg}/)</textarea>'
        }
    }
